                ...
                <div class="card-body">
                    <form v-on:submit="guardar">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" v-model="description" id="descripcion" class="form-control" maxlength="150" placeholder="Descripción" required>
                        </div>

                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa-solid fa-dollar-sign"></i></span>
                            <input type="text" v-model="price" id="precio" class="form-control" placeholder="Precio" step="0.01" required>
                        </div>
...
<script>
    ...
    export default{
        data(){
            return{
                id:0,name:'',description:'',price:'',url:'http://localhost/api/products'
            }
        },
        mounted(){
        ...
        ,methods:{
            ...
            guardar(){
                ...
                if(this.name.trim()===''){
                    ...
                    show_alerta('Escribe el descripción','warning','descripción');
                }
